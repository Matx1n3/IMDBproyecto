...
public class Pelicula {
    ...
    public void imprimirInfoPelicula(){
        System.out.println("\n--------------------------------------");
        System.out.println("Titulo: " + titulo);
        System.out.println("Numero de interpretes: " + listaInterpretes.getNumDeInterpretes());
        for (int i = 0; i < listaInterpretes.getNumDeInterpretes(); i++){
            System.out.println(listaInterpretes.getInterprete(i).getNombre());
        }
        System.out.println("--------------------------------------");
    }
